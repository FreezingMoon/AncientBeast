...
separate_segment();
echo "<div class='center'><a href='" . $site_root . "combat' target='_blank'><img src='launcher.jpg' width=890 height=400><h3 style='position:absolute; top:325px; left:100px;'>Launch Developer Preview [HotSeat]</h3></a></div>";
//separate_segment();
