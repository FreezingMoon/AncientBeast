...
separate_segment();
echo "<div class='center shadow' style='margin:5px 0px;'><a href='" . $site_root . "combat' target='_blank'><img src='launcher.jpg' width=890 height=400><h3 style='position:absolute; top:325px; left:100px; background:rgba(0,0,0,0.5); border-radius:15px; border:4px ridge red; padding: 15px;'>Launch Developer Preview [HotSeat]</h3></a></div>";
//separate_segment();
...
<li>controller (<span class='strike'>keyboard</span>, mouse, <span class='strike'>gamepad</span>, touch screen, <span class='strike'>smartphone</span> or <span class='strike'>tablet</span>)</li>
</ul>
