...
separate_segment();
echo "<div class='center'><a href='http://AncientBeast.com/combat' target='_blank'><img src='launcher.jpg' width=890 height=400><h3 style='position:inherit;'>Launch Developer Preview [HotSeat mode]</h3></a></div>";
//separate_segment();
