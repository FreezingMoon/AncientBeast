...
function end_page() {
	...
	<td><a href="http://www.FreezingMoon.org" target="_blank" class="lighten"><img src="http://www.FreezingMoon.org/images/FreezingMoon.png" style="width:444px;" class="lighten"></a></td>
	<td style="width:50%"></td>
