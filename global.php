...
function end_page() {
	...
	<td><a href="/donate"><img src="<?php echo $GLOBALS['site_root']; ?>/donate/paypal.png" height="63" width="56" alt="paypal"></a></td>
	<td><a href="bitcoin:1Gpa3NKn8nR9ipXPZbwkjYxqZX3cmz7q97?label=Ancient%20Beast"><img src="<?php echo $GLOBALS['site_root']; ?>/donate/bitcoin.png" height="63" width="56" alt="bitcoin"></a></td>
	...
	<td>
		...
		<img src="<?php echo $GLOBALS['site_root']; ?>/images/Freezing_Moon.png" height="52" width="444" alt="Freezing Moon" class="lighten"></a>
	...
	<td style="width:50%"></td>
	<td><a href="https://facebook.com/AncientBeast" target="_blank" class="lighten"><img src="<?php echo $GLOBALS['site_root']; ?>/images/facebook.png" height="64" width="64" class="lighten" alt="facebook"></a></td>
	<td><a href="https://twitter.com/AncientBeast" target="_blank" class="lighten"><img src="<?php echo $GLOBALS['site_root']; ?>/images/twitter.png" height="64" width="64" class="lighten" alt="twitter"></a></td>
	<td><a href="https://plus.google.com/b/113034814032002995836" target="_blank" class="lighten"><img src="<?php echo $GLOBALS['site_root']; ?>/images/google.png" height="64" width="64" class="lighten" alt="google"></a></td>
	</tr></table></div>
	<?php end_segment(); ?>
	</div>
	</body>
