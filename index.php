...
include("header.php");
echo $start_div; ?>
<table style="background: url('/images/trailer.jpg') no-repeat center top; height: 400px;">
<tr><td width=25%>
<center>
...
<center><iframe width="480" height="360" src="http://www.youtube.com/embed/KBS03PBHtqQ?rel=0" frameborder="0" allowfullscreen></iframe></center>
</td><td width=25%>
<center>
	<a href='http://www.facebook.com/AncientBeast' target='_blank'><img src='/images/facebook.png'></a><br><br><br><br><br>
	<a href='http://twitter.com/AncientBeast' target='_blank'><img src='/images/twitter.png'></a><br><br><br><br><br>
	<a href='http://feeds.feedburner.com/AncientBeast' target='_blank'><img src='/images/rss.png'></a>
</center>
</td></tr></table>
<? echo $separator; ?>
