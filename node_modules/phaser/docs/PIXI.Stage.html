...
<dt>
    <h4 class="name "
        id="Stage"><span class="type-signature"></span>new Stage<span class="signature">(backgroundColor)</span><span class="type-signature"></span></h4>
...
<dd>
    ...
    <div class="description">
        <p>A Stage represents the root of the display tree. Everything connected to the stage is rendered</p>
    </div>
...
<span class="param-type">Number</span>
            ...
            <td class="description last"><p>the background color of the stage, you have to pass this in is in hex format
     like: 0xFFFFFF for white</p>
<p>Creating a stage is a mandatory process when you use Pixi, which is as simple as this : 
var stage = new PIXI.Stage(0xFFFFFF);
where the parameter given is the background colour of the stage, in hex
you will use this stage instance to add your sprites to it and therefore to the renderer
Here is how to add a sprite to the stage : 
stage.addChild(sprite);</p></td>
        </tr>
...
<dl class="details">
    ...
    <a href="src_pixi_display_Stage.js.html">pixi/display/Stage.js</a>, <a href="src_pixi_display_Stage.js.html#sunlight-1-line-5">line 5</a>
    </dt>
...
<span class="param-type">Number</span>
            ...
            <td class="description last"><p>the color of the background, easiest way to pass this in is in hex format
     like: 0xFFFFFF for white</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source -
    <a href="src_pixi_display_Stage.js.html">pixi/display/Stage.js</a>, <a href="src_pixi_display_Stage.js.html#sunlight-1-line-61">line 61</a>
    </dt>
