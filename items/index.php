...
while ($row = mysql_fetch_assoc($result)) {
	$i++;
	echo '<td class="item"><span style="cursor:pointer;" class="lighten"><a href="#'.$row["id"].'"><img class="fix" src="'.$WorkingDir.'items/icons/'.$row["name"].'.png" style="display:block;"><br>'.$row["name"].'</a></span></td>';
	if (($i % 6) == 0) echo '</tr><tr>';
}
