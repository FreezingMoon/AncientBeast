...
<!--logged out-->
<span style="position: absolute; margin-left: -423px; padding-top: -20px; text-shadow: 0.1em 0.1em 0.1em black, 0 0 0.7em black;"><a href="#register" onclick="TINY.box.show({url:'/profile/register.php',post:'id=16',width:200,height:180,opacity:40,topsplit:5})">Register</a></span>
<span style="position: absolute; margin-left: 366px; padding-top: -20px; text-shadow: 0.1em 0.1em 0.1em black, 0 0 0.7em black;"><a href="#login" onclick="TINY.box.show({url:'/profile/login.php',post:'id=16',width:200,height:200,opacity:40,topsplit:5})">Login</a></span>
