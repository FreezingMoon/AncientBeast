...
export const unitData: UnitDataStructure = [
	...
	},
	{
		...
		ability_info: [
			{
				title: 'Life Support',
				desc: 'Gains one endurance for every two non-lethal damage taken, resisting fatigue.',
				info: 'Sado-masochistic endurance gain type.',
				upgrade: 'endurance pool avoids death.',
			},
			{
				title: 'Knuckle Nib',
				desc: 'Smashes its ringed head into an enemy, gradually lowering their defense stat.',
				info: '12 crush damage, -2 defense per hit.',
				upgrade: 'can push foe based on size.',
				effects: [
					{
						special: '-2 defense debuff on hit.',
					},
				],
				damages: {
					crush: 12,
			...
			{
				title: 'Dual Swipe',
				desc: 'Slaps nearby units using both its claws, quickly attacking all of them two times.',
				info: '7 slash + 7 crush + 7 sonic damage / hit.',
				upgrade: '+1 offense for each hit done.',
				damages: {
					slash: 7,
					crush: 7,
					sonic: 7,
		...
		ability_info: [
			{
				...
				upgrade: 'Can revive if nothing on top.',
			},
			{
				title: 'Gummy Mallet',
		...
		ability_info: [
			{
				...
				upgrade: 'Remaining energy also burns.',
				damages: {
					burn: 10,
					crush: 10,
					sonic: 10,
			...
			},
			{
				...
				info: '30 burn damage -1 for each hexagon.',
				upgrade: 'cauterizes wounded nearby.',
				damages: {
					burn: 30,
				},
				costs: {
