	...
	G.abilities[14] = [
		...
		// Second Ability: Gummy Mallet
		{
			...
			activate: function (hexes: Hex[]) {
				...
				G.gameEngine.cameras.main.shake(0.02, 333, true, G.gameEngine.cameras.main.SHAKE_VERTICAL, true);
		...
		// Third Ability: Pretty Ribbon
		{
			...
			activate: function (target: Creature) {
				this.end();
				G.gameEngine.cameras.main.shake(0.01, 100, true, G.gameEngine.cameras.main.SHAKE_VERTICAL, true);
