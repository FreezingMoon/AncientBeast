...
G.abilities[12] = [
	...
	// 	First Ability: Bunny Hop
	{
		...
		_getHopHex: function(fromHex) {
			...
			switch (id) {
				case 0:
					hex = this.creature.getHexMap(utils.matrices.backbottom1hex())[0];
					break;
				case 1:
					hex = this.creature.getHexMap(utils.matrices.inlineback1hex())[0];
					break;
				case 2:
					hex = this.creature.getHexMap(utils.matrices.backtop1hex())[0];
					break;
			}
