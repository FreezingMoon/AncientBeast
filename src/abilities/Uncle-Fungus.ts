	...
	G.abilities[3] = [
		...
		//	Second Ability: Supper Chomp
		{
			...
			activate: function (target) {
				this.end();
				G.gameEngine.cameras.main.shake(0.01, 65, true, Phaser.camera.SHAKE_HORIZONTAL, true);
			...
			activate: function (hex) {
				...
				this.creature.moveTo(hex, {
					...
					callback: () => {
						...
						G.gameEngine.cameras.main.shake(0.03, 90, true, Phaser.camera.SHAKE_VERTICAL, true);
		...
		// Fourth Ability: Sabre Kick
		{
			...
			activate: function (target) {
				this.end();
				G.gameEngine.cameras.main.shake(0.03, 100, true, Phaser.camera.SHAKE_HORIZONTAL, true);
