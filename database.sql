...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 04, 2013 at 07:34 AM
...
(2, 'Backstabber', 'Reduces damage from behind and returns some to melee attackers.', '', 'Metallic Claws', 'Razor sharp claws help him really shred his foes.', 'No info', 'Tail Mace', 'Whips out it''s scepter like tail to bluntly punish a distant foe.', 'No info', 'Brain Power', 'Electro-charges it''s brain functions to shock all nearby foes.', 'No info'),
(3, 'Spore Contamination', 'Nearby foes have their regrowth stat constantly reduced with each round.', '', 'Chomp', 'Takes a huge bite out of his foe, restoring a minor amount of health.', 'No info', 'Blade Kick', 'Slashes nearby foe using feet claws.', 'No info', 'Frogger', 'Leaps in straight line over obstacles, gaining bonus offense after landing.', 'No info'),
...
(7, 'Eye of the Fire', 'Strategically teleports to a new location on the combat field.', '', 'Fiery Claw', 'Scratch and burn a nearby foe.', 'No info', 'Fire Ball', 'Throws a ball of fire that explodes on impact, damaging several creatures.', 'No info', 'Infernal Pyre', 'Increases power of it''s back fire in order to burn all adjacent creatures.', 'No info'),
...
(11, 'Spore Contamination', 'Nearby foes have their regrowth constantly reduced with each round.', '', 'Head Bash', 'Bumps it''s large cap into nearby foe.', 'No info', 'Organic Recycling', 'Consumes the corpse underneath, restoring a minor amount of health.', 'No info', 'Noxious Cloud', 'Releases several toxic clouds all around, persisting for several rounds.', 'No info'),
(12, 'Bunny Hopping', 'Avoids basic attack by moving to an available adjacent location.', '', 'Big Nip', 'Dents nearby foe using it''s big teeth.', 'No info', 'Blowing Wind', 'Pushes an inline creature several hexagons backwards, based on size.', 'No info', 'Chilling Spit', 'Spits inline foe with cold saliva. Bonus damage based on distance.', 'No info'),
(13, 'Decaying Carcass', 'When dead, it''s corpse rots fast and emanates poisonous gases.', '', 'Sync Teeth', 'Bites a nearby foe.', 'No info', 'Bad Breath', 'Stinks up several nearby enemies.', 'No info', 'Toxic Bubble', 'Creates a mucus bubble from it''s nose and pushes it away.', 'No info'),
...
(19, 'Blood Chalice', 'Doing damage restores own health.', '', 'Slice', 'Claw swipe gesture, slashing a nearby foe.', 'No info', 'Fatal Attraction', 'Causes a target foe to come close to her, while depleting it''s movement.', 'No info', 'Tentacle Feet', 'All nearby foes have their movement restrained and take some damage.', 'No info'),
...
(24, 'Healing Factor', 'Bonus regrowth for all nearby allies.', '', 'Gauntlet Strike', 'Punches a nearby foe with it''s heavy armored hand, leaving quite a mark.', 'No info', 'Bloody Greed', 'Powerful sword penetrating attack, affecting multiple inline hexagons.', 'No info', 'Supreme Motivation', 'Greed drives it to do an extra effort and act twice in the current round.', 'No info'),
...
(28, 'No name', 'No description', '', 'No name', 'No description', 'No info', 'No name', 'No description', 'No info', 'No name', 'No description', 'No info'),
(29, 'Bad Touch', 'Every three strikes, a melee attacker is turned to gold for several rounds.', '', 'Red Crystal', 'Pokes nearby foe using staff.', 'No info', 'Winged Orb', 'Heals an ally or damages a foe that''s at the target location next round.', 'No info', 'Burning Light', 'Conjures a beam of pure energy that will cause burns to all inline foes.', 'No info'),
...
(34, 'No name', 'No description', '', 'No name', 'No description', 'No info', 'No name', 'No description', 'No info', 'No name', 'No description', 'No info'),
...
(37, 'Spa Mud', 'Gains temporary bonus regrowth and defense when entering a mud bath.', '', 'Power Bat', 'Pokes baseball bat into nearby foe.', 'No info', 'Ground Ball', 'Strikes a mud boulder towards a foe.', 'No info', 'Mud Bath', 'Orders a pile of mud at a location, slowing foes passing through.', 'No info'),
...
(44, 'Feathered', 'Can fly to available locations within movement range, avoiding obstacles.', '', 'Slicing Talon', 'Slashes nearby foe using claws.', 'No info', 'Special Delivery', 'Drops a boulder at the selected location, damaging a creature.', 'No info', 'Escort Service', 'Carries any small or medium creature to a new location. Also damages foes.', 'No info'),
(45, 'Duality', 'Allows the use of an attack twice.', '', 'Tooth Fairy', 'Syncs teeth into nearby foe.', 'No info', 'Power Note', 'Sings a very powerful note to a foe.', 'No info', 'Chain Lightning', 'Releases a lightning bolt that will arch, shocking multiple creatures.', 'No info'),
...
(0, 'Artificial Satellite', 'Protects from all harm and also facilitates distant materialization.', '', 'Electroshock', 'Does shock damage to a nearby foe. Effective versus larger creatures.', 'No info', 'Disintegration', 'Does pure damage to a nearby foe. Bonus based on it''s missing health.', 'No info', 'Materialization', 'Summons a creature on the combat field that will serve and obey orders.', 'No info'),
...
(44, 90, 100, 100, 0, 0, 10, 0, 0, 10, 0),
(45, 60, 100, 100, 0, 0, 10, 0, 0, 10, 0),
...
(3, 140, 10, 50, 140, 7, 85, 30, 10, 4, 6, 7, 8, 3, 4, 6, 20, 5, 3),
(4, 140, 4, 80, 90, 3, 80, 15, 15, 3, 12, 12, 12, 12, 20, 0, 25, 5, 0),
...
(45, 260, 7, 40, 80, 8, 50, 20, 20, 4, 8, 8, 8, 15, 10, 9, 8, 15, 12),
