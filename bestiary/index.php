...
foreach(range(1, 7) as $x) echo "<div style=\"background:url('" . $WorkingDir . "creatures/$x/avatar.jpg'); background-size: 100%; display: inline-block;\"><a href=\"?id=$x#\" class=\"lighten\"><img class=\"img lighten\" src=\"frame.png\"></a></div>";
