module battle {
    ...
    export class PathFinder{
        ...
        grid; // referencce to the master grid
        fringes; // new paths are generated by checking around fringes
        newFringes; // after we have checked all the new paths, old fringes are deleted and newFringes become fringes
        pathContainer; // a copy of the grid, valid paths are saved as pathContainer nodes.
        walkableTiles; // tiles that have a path leading to it
